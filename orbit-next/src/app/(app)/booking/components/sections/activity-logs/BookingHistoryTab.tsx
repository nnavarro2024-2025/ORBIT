            ...
            >
              ...
              <div className="lg:hidden">
                ...
                {(items.length > 0 || hasOthers) && (
                  <div className="mt-2">
                    <h5 className=" font-bold text-gray-700 uppercase tracking-wider mb-1">Booked Equipment</h5>
                    <div className="space-y-1">
                      {items.slice(0, 3).map((item: string, idx: number) => (
                        <div key={`eq-mob-${id}-${idx}`} className="text-xs">
                          <span className="text-gray-700 font-medium truncate">{item}</span>
                        </div>
                      ))}
                      {hasOthers && (
                        <div className="text-xs text-gray-700">
                          Other: {String(eq.others).trim()}
                        </div>
                      )}
                      {items.length > 3 && (
          ...
          {selectedBooking && (
            <div className="space-y-4">
              ...
              {selectedBooking.equipment && (
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-2">Booked Equipment</h3>
                  <div className="space-y-2">
